...
import pickle
from OPS2NetUtils2 import getStatus2, getClassif,getCitations, getFamilyLenght, isMaj, quote, UnNest, GenereDateLiens
...
#        appariement['inventor-IPCR4'] = ['inventeur','IPCR4']
        appariement['inventor-IPCR7'] = ['inventeur','IPCR7']
