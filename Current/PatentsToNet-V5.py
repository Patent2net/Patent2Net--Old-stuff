...
if not ndf.endswith(".dump"):    
    ...
    print "use after OPSGatherAugment-Families"


ResultPath = 'PatentsBiblio'
ResultPathGephi = 'GephiFilesV5'
...
#""")
    ...
    os.rename(ResultPathGephi+'\\'+"Good"+ndf+'2.gexf', ResultPathGephi+'\\'+ndf.replace('.dump', '')+'5.gexf')
    print "Network file writen in ",  ResultPathGephi+' directory.\n See file: '+ndf.replace('.dump', '')+'5.gexf'
