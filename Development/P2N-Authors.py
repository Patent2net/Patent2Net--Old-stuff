...
import pickle
from P2N_Lib import  isMaj, quote, GenereDateLiens, ReturnBoolean, FormateGephi,GenereListeSansDate, GenereReseaux3, cmap_discretize
...
#                Brev['date'] = datetime.date(datetime.date.today(), 1, 1)
    ...
    #    nx.set_node_attributes(G, 'viz:pos', pos)
        #nx.set_node_attributes(G, 'viz:size', deg)
...
#        except:
#            pass
#        os.rename(ResultPathGephi+'\\'+"Good"+ndf+'2.gexf', ResultPathGephi+'\\'+ndf.replace('.dump', '')+network+'.gexf')
#        print "Network file writen in ",  ResultPathGephi+' directory.\n See file: '+ndf.replace('.dump', '')+network+'.gexf'
