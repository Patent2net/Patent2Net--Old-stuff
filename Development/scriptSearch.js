...
$('#example tfoot th').each( function () {
    ...
    function filter_table(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11, param12, param13, param14, param15, param16, param17, param18, param19){
    ...
    $('tfoot').find('tr').find('th').each(function(){
        $(this).find('input').on('keyup', function(){   
            ...
            $.fn.dataTableExt.afnFiltering.pop();
                   filter_table(inputText[0],inputText[1],inputText[2],inputText[3],inputText[4],inputText[5],inputText[6],inputText[7],inputText[8],inputText[9],inputText[10],inputText[11],inputText[12],inputText[13],inputText[14],inputText[15],inputText[16],inputText[17],inputText[18]);
                        table.draw();    
        });
    });
